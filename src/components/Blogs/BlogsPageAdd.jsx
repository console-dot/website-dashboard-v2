      ...
      <form className="flex justify-center flex-col w-[50%] m-auto gap-2" method="post" onSubmit={handleSubmit}>
        <div>
          ...
          <textarea
            ...
            placeholder="Blog Excerpt (optional - will be auto-generated if empty)"
          />
          ...
          <div className="flex justify-center gap-6 w-full mt-4">
            {formData?.featuredImage ? (
              <div className="flex">
                <img
                  src={`${BASE_URL}/file/${formData?.featuredImage}`}
        ...
        <div className="w-full flex justify-center items-center mt-4 mb-4">
          ...
          >
            {isLoading ? (
              ...
              <p className="font-Lato text-base font-medium leading-[28px] tracking-normal">Create Blog</p>
            )}
          </button>
          <ToastContainer />
        </div>
