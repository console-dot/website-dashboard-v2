...
export default function CaseStudiesPageEdit() {
  ...
  useEffect(() => {
    if (caseStudiesData) {
      setFormData({
        ...caseStudiesData,
        highlights: caseStudiesData.highlights || [],
        goals: caseStudiesData.goals || [],
        challenges: caseStudiesData.challenges || [],
        results: caseStudiesData.results || { subHeadings: [] },
        techStack: caseStudiesData.techStack || [],
        images: caseStudiesData.images || [],
        client: caseStudiesData.client || [
          {
            name: "",
            description: "",
            country: "",
  ...
  //tech Stack functionality start
