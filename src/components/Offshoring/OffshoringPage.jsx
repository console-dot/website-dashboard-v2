...
import { getoffshoreservicepage } from "../../api/offshoreservice";
import { setoffshoreserviceData } from "../../redux/offshoreserviceSlice";
...
export const OffshoringPage = () => {
  ...
  useEffect(() => {
    getoffshoreservicepage()
      .then((res) => {
        setData(res?.data);
        dispatch(setoffshoreserviceData(res?.data));
      })
