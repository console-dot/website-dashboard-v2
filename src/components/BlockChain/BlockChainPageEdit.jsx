      ...
      >
        ...
        <div>
          ...
          <div className="border border-dashed flex flex-col border-custom-purple p-4 mt-6">
            ...
            {/* Database */}
            <div className="w-full text-webDescrip font-semibold">Development Tools</div>
            {formData?.techStack?.map((item, index) =>
              item?.type === "DevelopmentTools" ? (
                <div className="w-full flex" key={item.name}>
                  <div className="w-full flex justify-between">
                    <div>{item?.name}</div>
                    <div className="flex items-center">
            ...
            {/* CI/CD */}
            <div className="w-full text-webDescrip font-semibold">Decentralized Storage</div>
            {formData?.techStack?.map((item, index) =>
              item?.type === "DecentralizedStorage" ? (
                <div className="w-full flex" key={item.name}>
                  <div className="w-full flex justify-between">
                    <div>{item?.name}</div>
                    <div className="flex items-center">
            ...
            <div className="mb-4">
              ...
              <div className="mb-4">
                ...
                >
                  ...
                  <option value="BlockchainPlatforms">
                    BlockchainPlatforms
                  </option>
                  <option value="SCL">
                  Smart Contract Languages
                  ...
                  <option value="DecentralizedStorage">Decentralized Storage</option>
